...
#define AI_NETWORK_1_IN_1_SIZE        (96 * 96 * 3)
#define AI_NETWORK_1_IN_1_SIZE_BYTES  (27649)
...
#define AI_NETWORK_1_OUT_1_HEIGHT      (12)
#define AI_NETWORK_1_OUT_1_WIDTH       (12)
#define AI_NETWORK_1_OUT_1_CHANNEL     (48)
#define AI_NETWORK_1_OUT_1_SIZE        (12 * 12 * 48)
#define AI_NETWORK_1_OUT_1_SIZE_BYTES  (6912)
