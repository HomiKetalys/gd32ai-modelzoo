...
from val import validate as evaluate
...
def export(opt,save_path):
    ...
    pytorch2onnx_main(opt.config, opt.weight, onnx_path,opt.img_size)
...
val_paths={
    'food-101':'../../../datasets/food-101/validation',
}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight', type=str, default="results/train/20240327-181513-mobilenet_v3_small_0_75-224/model_best.pth.tar",
