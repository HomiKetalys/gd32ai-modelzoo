...
#define AI_NETWORK_1_IN_1_HEIGHT      (64)
#define AI_NETWORK_1_IN_1_WIDTH       (64)
#define AI_NETWORK_1_IN_1_CHANNEL     (3)
#define AI_NETWORK_1_IN_1_SIZE        (64 * 64 * 3)
#define AI_NETWORK_1_IN_1_SIZE_BYTES  (12289)
...
#define AI_NETWORK_1_OUT_1_SIZE        (8 * 8 * 48)
#define AI_NETWORK_1_OUT_1_SIZE_BYTES  (3072)
