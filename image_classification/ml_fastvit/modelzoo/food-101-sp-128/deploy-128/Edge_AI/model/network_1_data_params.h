...
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZES \
  { 30660, }
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZE     (30660)
#define AI_NETWORK_1_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_1_DATA_ACTIVATION_1_SIZE    (30660)



#define AI_NETWORK_1_DATA_WEIGHTS_SIZES \
  { 23904, }
#define AI_NETWORK_1_DATA_WEIGHTS_SIZE         (23904)
#define AI_NETWORK_1_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_1_DATA_WEIGHT_1_SIZE        (23904)
