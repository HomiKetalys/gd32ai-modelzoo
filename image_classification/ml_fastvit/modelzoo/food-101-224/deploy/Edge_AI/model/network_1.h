...
#define AI_NETWORK_1_IN_1_HEIGHT      (224)
#define AI_NETWORK_1_IN_1_WIDTH       (224)
#define AI_NETWORK_1_IN_1_CHANNEL     (3)
#define AI_NETWORK_1_IN_1_SIZE        (224 * 224 * 3)
#define AI_NETWORK_1_IN_1_SIZE_BYTES  (150529)
