...
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZES \
  { 235716, }
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZE     (235716)
#define AI_NETWORK_1_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_1_DATA_ACTIVATION_1_SIZE    (235716)



#define AI_NETWORK_1_DATA_WEIGHTS_SIZES \
  { 289656, }
#define AI_NETWORK_1_DATA_WEIGHTS_SIZE         (289656)
#define AI_NETWORK_1_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_1_DATA_WEIGHT_1_SIZE        (289656)
