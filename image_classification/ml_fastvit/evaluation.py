...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='modelzoo/food-101-sp-128/deploy-128/food-101.yaml',
                        help='Specify training profile *.data')
    parser.add_argument('--model_path', type=str, default="modelzoo/food-101-sp-128/deploy-128/tflite",
