...
*********************************************************************************************************/
//背景显存缓冲区首地址
#define BACK_FRAME_START_ADDR (0xC1000000)
...
*********************************************************************************************************/
//背景显存
static u16 s_arrBackgroundFrame[(LCD_PIXEL_WIDTH + 1) * LCD_PIXEL_HEIGHT] __attribute__((section(".ARM.__at_0xC1000000")));
//#define s_arrBackgroundFrame image_background0

//前景显存
static u16 s_arrForegroundFrame[(LCD_PIXEL_WIDTH + 1) * LCD_PIXEL_HEIGHT] __attribute__((section(".ARM.__at_0xC1080000")));
//#define s_arrForegroundFrame image_background0
...
//    tli_layer_init_struct.layer_window_leftpos    = 45;             //窗口左侧位置
//    tli_layer_init_struct.layer_window_rightpos   = (43 + 480 - 1); //窗口右侧位置
//    tli_layer_init_struct.layer_window_toppos     = 12;                 //窗口顶部位置
//    tli_layer_init_struct.layer_window_bottompos  = (12 + 272 - 1);    //窗口底部位置
...
void LCDDrawPoint(u32 x, u32 y, u32 color)
{
  ...
  {
    g_structTLILCDDev.frameBuf[height * (width-1-x) + y] = color;
  }
}
