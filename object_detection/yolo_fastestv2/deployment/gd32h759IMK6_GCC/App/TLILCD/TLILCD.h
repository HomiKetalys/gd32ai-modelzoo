...
//屏幕宽度和高度定义
#define LCD_PIXEL_WIDTH          ((u32)480)
#define LCD_PIXEL_HEIGHT         ((u32)272)

//LCD 参数，行时序按像素点计算，帧时序按照行数计算
#define HORIZONTAL_SYNCHRONOUS_PULSE  41  //行同步
#define HORIZONTAL_BACK_PORCH         2  //显示后沿
#define ACTIVE_WIDTH                  480 //显示区域
#define HORIZONTAL_FRONT_PORCH        2  //显示前沿

#define VERTICAL_SYNCHRONOUS_PULSE    10   //场同步
#define VERTICAL_BACK_PORCH           1  //显示后沿
#define ACTIVE_HEIGHT                 272 //显示区域
#define VERTICAL_FRONT_PORCH          2  //显示前沿
