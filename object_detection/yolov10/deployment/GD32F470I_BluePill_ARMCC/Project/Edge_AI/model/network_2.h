...
#ifndef AI_NETWORK_2_H
#define AI_NETWORK_2_H
#pragma once

#include "network_2_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_2_MODEL_NAME          "network_2"
#define AI_NETWORK_2_ORIGIN_MODEL_NAME   "model_post"

/******************************************************************************/
#define AI_NETWORK_2_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_2_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_2_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_2_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_2_IN \
  ai_network_2_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_2_IN_SIZE { \
  AI_NETWORK_2_IN_1_SIZE, \
}
#define AI_NETWORK_2_IN_SIZE_BYTES { \
  AI_NETWORK_2_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_2_IN_1_HEIGHT      (32)
#define AI_NETWORK_2_IN_1_WIDTH       (32)
#define AI_NETWORK_2_IN_1_CHANNEL     (48)
#define AI_NETWORK_2_IN_1_SIZE        (32 * 32 * 48)
#define AI_NETWORK_2_IN_1_SIZE_BYTES  (49152)

/******************************************************************************/
#define AI_NETWORK_2_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_2_OUT \
  ai_network_2_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_2_OUT_SIZE { \
  AI_NETWORK_2_OUT_1_SIZE, \
}
#define AI_NETWORK_2_OUT_SIZE_BYTES { \
  AI_NETWORK_2_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_2_OUT_1_HEIGHT      (256)
#define AI_NETWORK_2_OUT_1_CHANNEL     (85)
#define AI_NETWORK_2_OUT_1_SIZE        (256 * 85)
#define AI_NETWORK_2_OUT_1_SIZE_BYTES  (87040)

/******************************************************************************/
#define AI_NETWORK_2_N_NODES (108)
 ...
 * @ref ai_network_2_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_2_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_2_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_2_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_2_*
 * defines into file @ref network_2.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_2_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_2_H */
