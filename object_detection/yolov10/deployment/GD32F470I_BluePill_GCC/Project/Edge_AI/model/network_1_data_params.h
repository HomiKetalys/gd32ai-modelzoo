...
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZES \
  { 108612, }
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZE     (108612)
#define AI_NETWORK_1_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_1_DATA_ACTIVATION_1_SIZE    (108612)



#define AI_NETWORK_1_DATA_WEIGHTS_SIZES \
  { 10020, }
#define AI_NETWORK_1_DATA_WEIGHTS_SIZE         (10020)
#define AI_NETWORK_1_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_1_DATA_WEIGHT_1_SIZE        (10020)
